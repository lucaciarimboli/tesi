...
Point(1) = {1e-6, -200, 0, lc0};
Point(2) = {400, -200, 0, lc0};
Point(3) = {400, 200, 0, lc0};
Point(4) = {1e-6, 200, 0, lc0};

Point(5) = {1e-6, 6, 0, lc1};
Point(6) = {1e-6, -6, 0, lc1};
...
// Plane Surface(2) = {2,-5001}; // Inside limiter
// Plane Surface(1000) = {5001}; // Inside limiter
...
Physical Curve("Boundary",15) = {1,2,3,4,5,6};
// Physical Curve("Gamma_N",26) = {1,2,3};
// Physical Curve("Gamma_D",27) = {4,5,6};
